...
def boar_brawl(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 2
    "*** YOUR CODE HERE ***"
    one_digit_player = player_score % 10
    ten_digit_opponent = opponent_score // 10 % 10
    points = 3 * abs(one_digit_player - ten_digit_opponent)
    if points < 1:
        return 1
    else:
        return points
...
def always_roll(n):
    ...
    # BEGIN PROBLEM 6
    "*** YOUR CODE HERE ***"
    def roll_strategy(score0, score1):
        return n
...
def is_always_roll(strategy, goal=GOAL):
    ...
    "*** YOUR CODE HERE ***"
    i, k = 0, 0
    nums_roll = strategy(i, k)
    while i < goal:
        while k < goal:
            if strategy(i, k) != nums_roll:
                return False
            k += 1
        i += 1
        k = 0
